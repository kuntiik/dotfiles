...
sbar.exec(query_workspaces, function(workspaces_and_monitors)
    for _, entry in ipairs(workspaces_and_monitors) do
        ...
        -- local workspace_bracket = sbar.add("bracket", { "workspace." .. workspace_index }, {
        --     background = {
        ...
        -- -- New: Add a padding item for this workspace
        -- sbar.add("space", "workspace.padding." .. workspace_index, {
        --     space = workspace_index,
        --     script = "",
